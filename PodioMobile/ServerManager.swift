...
public typealias ServerCallback = ((AnyObject?, error: Bool) -> Void)
public typealias NewEmptyArray = [String : AnyObject]

public enum ServerOperationMethod: Int
{
...
public class ServerManager: NSObject {
	...
	public func setAuthorization(authorization: String?)
	{
	...
	public func performServerRequest(route: String, parameters: [String : AnyObject]?, method: ServerOperationMethod, completion: ServerCallback)
	{
	...
	public func loginWithUsernamePassword(username: String, password: String, completion: ServerCallback)
	{
	...
	public func retreiveUserOrganizations(completion: ServerCallback)
	{
